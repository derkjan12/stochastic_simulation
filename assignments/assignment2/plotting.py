...
def plot_conf_intervals2(plot_range, title, x_label, y_label, mean_arr1, std_arr1,
    ...
    plt.plot(plot_range, mean_arr1, 'g', label=label1)
    plt.plot(plot_range, mean_arr2, 'r', label=label2)
    plt.fill_between(plot_range, lower_bound1, upper_bound1, 
    ...
    if mean_arr3 is not None and std_arr3 is not None and label3 is not None:
        ...
        plt.plot(plot_range, mean_arr3, 'b', label=label3)
...
plot_data1 = get_plotting_data("MM4_FIFO_ex1.json")
_, mean_arr2, std_arr2 = get_plotting_data(
    "Mhyperexp4_FIFO_0.1_0.9.json"
)
_, mean_arr3, std_arr3 = get_plotting_data("MD4_FIFO_0.1_0.9.json")
